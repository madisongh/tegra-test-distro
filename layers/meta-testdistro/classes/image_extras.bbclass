...
# with the system installer.  See the definition of IMAGE_CMD:tar in
...
IMAGE_ROOTFS_SIZE:cryptparts = "${@d.getVar('MENDER_IMAGE_ROOTFS_SIZE_DEFAULT') or int(tegra_default_rootfs_size(d)) * 9 // 10}"

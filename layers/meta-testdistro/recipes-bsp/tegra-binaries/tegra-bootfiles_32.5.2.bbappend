...
EXTRADEPS_append_jetson-tx1-devkit = " custom-flash-layout"
EXTRADEPS_append_jetson-agx-xavier-devkit = " custom-flash-layout"
EXTRADEPS_append_jetson-xavier-nx-devkit-emmc = " custom-flash-layout"
DEPENDS += "${EXTRADEPS}"
...
PARTITION_FILE_jetson-tx1-devkit = "${STAGING_DATADIR}/custom-flash-layout/${PARTITION_LAYOUT_TEMPLATE}"
...
PARTITION_FILE_jetson-xavier-nx-devkit-emmc = "${STAGING_DATADIR}/custom-flash-layout/${PARTITION_LAYOUT_TEMPLATE}"

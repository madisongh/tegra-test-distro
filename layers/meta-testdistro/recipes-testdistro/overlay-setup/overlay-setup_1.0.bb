DESCRIPTION = "Script to set up directories for overlayfs mounts"
...
SRC_URI = "\
    file://overlay-setup.sh.in \
    file://overlay-setup.service.in \
"
...
do_install() {
    ...
    install -m 0755 ${B}/overlay-setup.sh ${D}${sbindir}/overlay-setup
